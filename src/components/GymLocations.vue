...
<template>
<v-container clas="mt-12">
    <v-row>
        <v-col>
            <div class="text-display-small mb-6">Our Location</div>
        </v-col>
    </v-row>
    <v-row>
        <v-col>
        <v-card>
            <v-row>
                ...
                <v-col md="8">
                    <div id="map2" style="height: 40vh;"></div>
                </v-col>
            </v-row>
        </v-card>
        </v-col>
     ...
     <v-row>
        ...
        <v-card>
            <v-row>
                ...
                <v-col md="8">
                    <div id="map3" style="height: 40vh;"></div>
                </v-col>
            </v-row>
        </v-card>
        </v-col>
     ...
     <v-row>
        ...
        <v-card>
            <v-row>
                ...
                <v-col md="8">
                    <div id="map4" style="height: 40vh;"></div>
                </v-col>
            </v-row>
        </v-card>
        </v-col>
